...
class __TwigTemplate_b825465473cb015c6f4628a0c17c65cef9ac993af686a95fa76703f640f71e7f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 3, $this->source); })()), "id", [], "any", false, false, false, 3))), "html", null, true);
        echo "\">
...
", "article/_delete_form.html.twig", "/Applications/MAMP/htdocs/sophie_lamalle/sophie_lamalle_psychologue/templates/article/_delete_form.html.twig");
    }
}

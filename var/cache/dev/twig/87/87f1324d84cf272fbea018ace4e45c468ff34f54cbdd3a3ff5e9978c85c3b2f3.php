...
class __TwigTemplate_56bde7a6354f13dfba287f0804c220e7c348e931cbb8ae0c5f985d97285cb154 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/Applications/MAMP/htdocs/sophie_lamalle/sophie_lamalle_psychologue/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
